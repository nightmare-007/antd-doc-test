(window.webpackJsonp=window.webpackJsonp||[]).push([[221],{3102:function(e,n){e.exports={content:["article",["p","You might want to replace Moment.js with another date library (",["strong","Ant design currently supports ",["a",{title:null,href:"https://day.js.org"},"dayjs"]," and ",["a",{title:null,href:"https://date-fns.org"},"date-fns"]],") to reduce bundle size. We provide two ways to customize:"],["h2","Custom component"],["p","The first way is to use ",["code","generatePicker"]," (or ",["code","generateCalendar"],") to help create Picker components."],["p","First, we initialize an antd demo with ",["code","create-react-app"],". You can refer to ",["a",{title:null,href:"/docs/react/use-in-typescript"},"Use in TypeScript"],", or you can start directly here ",["a",{title:null,href:"https://github.com/xiaohuoni/antd4-generate-picker/commit/47fec964e36d48bd15760f8f5abcb9655c259aa6"},"init antd"]],["h3","DatePicker.tsx"],["p","Create ",["code","src/components/DatePicker.tsx"],"."],["p","For example:"],["pre",{lang:"tsx",highlighted:`import { Dayjs } from <span class="token string">'dayjs'</span><span class="token comment" spellcheck="true">;</span>
